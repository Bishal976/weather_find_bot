# below is the simple demo code for the weather finder program
import requests
...
dictionary = r.json()
for i in range(6):
    date = dictionary['consolidated_weather'][i]['applicable_date']
    humidity = dictionary['consolidated_weather'][i]['humidity']
    print(f"{date}:\thumidity:{humidity}")

# the code and be modified to find other weather elements also


# below is the main program for the weather finder app
